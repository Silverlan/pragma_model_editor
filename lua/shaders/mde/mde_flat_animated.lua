...
function shader.MdeFlatAnimated:InitializeGfxPipelinePushConstantRanges(pipelineInfo,pipelineIdx)
  pipelineInfo:AttachPushConstantRange(0,shader.TexturedLit3D.PUSH_CONSTANTS_SIZE +util.SIZEOF_VECTOR4,bit.bor(prosper.SHADER_STAGE_FRAGMENT_BIT,prosper.SHADER_STAGE_VERTEX_BIT)) -- Color
end
