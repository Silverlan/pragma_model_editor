...
function ents.MdeModelPreviewComponent:GetSelectedBones() return self.m_selectedBones end

function ents.MdeModelPreviewComponent:SetShouldPlaySounds(b) self.m_bShouldPlaySounds = b end
function ents.MdeModelPreviewComponent:SetShouldShowMovement(b) self.m_bShouldShowMovement = b end
...
function ents.MdeModelPreviewComponent:OnTick(dt)
	...
	if(trComponent == nil or mdlComponent == nil or animComponent == nil) then return end
	if(animComponent:GetCycle() == 1.0) then animComponent:SetCycle(0.0) end
	local pos = Vector()
