...
gui.WIModelEditor.register_importer("smd",bit.bor(gui.WIModelEditor.IMPORT_TYPE_MESH,gui.WIModelEditor.IMPORT_TYPE_ANIMATION,gui.WIModelEditor.IMPORT_TYPE_PHYSICS),function(pEditor,mdl,mdlName,fOpen,importType,tFiles)
	local f = fOpen(false)
