...
function gui.WIModelViewer:OnInitialize()
	...
	self.m_container = gui.create("WIVBox",self,0,0,self:GetWidth(),self:GetHeight(),0,0,1,1)
...
function gui.WIModelViewer:GetModelName() return self.m_modelName end
...
function gui.WIModelViewer:GetModelView() return self.m_pModelView end
...
function gui.WIModelViewer:SetModel(mdlName)
	...
	if(mdl == self.m_model) then return end
	self.m_model = mdl
...
gui.register("WIModelViewer",gui.WIModelViewer)
